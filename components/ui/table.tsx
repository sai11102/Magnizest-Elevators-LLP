...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-neutral-200 bg-neutral-100/50 dark:border-neutral-800 dark:bg-neutral-800/50", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-neutral-200 bg-neutral-100/50 font-medium dark:border-neutral-800 dark:bg-neutral-800/50 [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
